...
session_start();
include("../../DB.php");
if ($_POST['countryCode'] != '86') {
    $_POST['temp_mobile'] = '00' . $_POST['countryCode'] . $_POST['mobile'];
    $_POST['mobile'] = $_POST['countryCode'] . $_POST['mobile'];
} else {
    $_POST['temp_mobile'] =  $_POST['mobile'];
}
...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAI9HVMvodg9qZr"; // AccessKeyId

        $accessKeySecret = "qNB9TSjUB87uwoIN31vsd1LHx64KAa"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($VerificationCode) {
        ...
        // 必填，设置短信接收号码
        $request->setPhoneNumbers($_POST['temp_mobile']);

        // 必填，设置签名名称，应严格按"签名名称"填写，请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/sign
        $request->setSignName("KGX凯格斯");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        if ($_POST['countryCode'] != '86') {
            $request->setTemplateCode("SMS_137410044");
        } else {
            $request->setTemplateCode("SMS_126685083");
        }
...
$db = new DB;
$db->query("INSERT INTO `signup_verification` VALUES (null, '" . date('Y-m-d H:i:s') . "', '" . $_POST['mobile'] . "', '" . $VerificationCode . "');");

$response = SmsDemo::sendSms($VerificationCode);
echo "ok";
//print_r($response);
/*
sleep(2);
