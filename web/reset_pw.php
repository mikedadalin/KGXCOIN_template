...
==================================== -->
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-12 col-lg-5">
              ...
              <div class="login-box card">
                <div class="card-body">
                  <form class="form-horizontal form-material" id="tran_pw_form" name="tran_pw_form">
                    <h3 class="box-title m-b-20">重设新密码</h3>

                    <div class="floating-labels">

                      <div class="form-group m-b-40">
                        <input type="text" name="input-mail" id="input-mail" class="form-control form-control-lg" value="" required="" aria-required="true">
                        <span class="bar"></span>
  ...
  <script src="assets/scripts/reset_pw.js"></script>
  <!-- Temp Scripts
  =====================================-->
  <script>
  </script>
